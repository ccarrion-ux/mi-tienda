...
async function main() {
  const plans = [
    ...
    { code: PlanCode.ENTERPRISE, name: "Enterprise", description: "Para empresas con necesidades avanzadas", monthlyPrice: 0, yearlyPrice: 0, maxProducts: null as number | null, maxUsers: null as number | null, aiCatalog: true, aiMarketing: true, advancedAnalytics: true, customDomain: true, sortOrder: 4 },
  ];
