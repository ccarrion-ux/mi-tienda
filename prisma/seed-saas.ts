...
async function main() {
  const plans = [
    ...
    { code: PlanCode.PRO, name: "Pro", description: "Para tiendas de mayor volumen", monthlyPrice: 28990, yearlyPrice: 289900, maxProducts: null, maxUsers: 10, aiCatalog: true, aiMarketing: true, advancedAnalytics: true, customDomain: true, sortOrder: 3 },
    { code: PlanCode.ENTERPRISE, name: "Enterprise", description: "Para empresas con necesidades avanzadas", monthlyPrice: 0, yearlyPrice: 0, maxProducts: null, maxUsers: null, aiCatalog: true, aiMarketing: true, advancedAnalytics: true, customDomain: true, sortOrder: 4 },
  ];
